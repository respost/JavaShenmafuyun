...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,showWeek:false,firstDay:0,weeks:["S","M","T","W","T","F","S"],months:["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
...
_b94(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确定",buttons:[{text:function(_ba9){
